        ...
        <div class="row align-items-md-stretch">
            <div class="col-md-3">
                <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <div>
                        <p>Aqui puedes buscar un Producto por codigo,barra,nombre.</p>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#NuevoProducto">Buscar Producto</button>
                        ...
                        <div class="modal fade" id="NuevoProducto" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('consulta.producto') }}" method="GET">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="form-floating mb-3">
                                                <input name="codigo" type="text" class="form-control" id="codigoInput"
                                                    required autofocus>
                                                <label for="codigoInput">Codigo, Barra o Nombre</label>
            ...
            <div class="col-md-3">
                <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <div>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#NuevoDespacho">Buscar Cliente</button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="#" method="GET">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-floating mb-3">
                                                <input name="cedula" type="text" class="form-control" id="cedulaInput"
                                                    required autofocus>
            ...
            <div class="col-md-3">
                <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <div>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#NuevaCompra">Buscar Proveedor</button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="#" method="GET">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-floating mb-3">
                                                <input name="rif" type="text" class="form-control" id="rifInput"
                                                    required autofocus>
            ...
            <div class="col-md-3">
                <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <div>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#BuscarDespacho">Buscar Despacho</button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('consulta.despacho') }}" method="GET">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-floating mb-3">
                                                <input name="desde" type="date" class="form-control" id="rifInput"
                                                    required autofocus>
                                                <label for="rifInput">Desde</label>
                                                <x-input-error :messages="$errors->get('desde')" class="mt-2" />
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input name="hasta" type="date" class="form-control" id="rifInput"
                                                    required autofocus>
