<x-app-layout>
    ...
    <div class="py-12">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex divide-x-4 divide-double divide-sky-400">
                    <div class="p-4 text-gray-900 dark:text-gray-100">
                        <h2 class="text-base/7 font-semibold text-white">Datos de Cliente</h2>
                        <p class="mt-1 text-sm/6 text-gray-400">Aqui se cargaran los Datos Importantes del Cliente.
                        <br>
     ...
     />
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="Nombre"
                                            class="block text-sm/6 font-medium text-white">Nombre Completo</label>
                                        <div class="mt-2">
     ...
     />
                                        ...
                                        <br>
                                        <x-primary-button>{{ __('Agrega Cliente') }}</x-primary-button>
                                    </div>
                            </form>
                        </div>
                    </div>
